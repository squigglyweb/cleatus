...
function tln_dir_shortcode($atts) {
    ...
    // Just show first 12 for now - no pagination
    ...
    foreach($page_items as $b) {
        ...
        echo '<div class="tln-img-wrap" style="position:relative"><div class="tln-img"><span style="font-size:3rem;color:#fff;">'.$icon.'</span></div>';
